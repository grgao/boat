...
\title{	\Large \textsc{ECE 455 Capstone Design in Electrical and Computer Engineering   \\
			...
			\LARGE \textbf{\uppercase{Development of a Low-Frequency Electromagnetic Emitting Autonomous Boat for Offshore Plane Wreckage Recovery}}	% Title
...
\input{Circuit_schem}
\input{Simulations and Circuit Board Design}
\input{Hardware}
\input{Software}
\input{Electrical}
