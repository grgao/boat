...
ADC.configINPUT(addr,'D1',13,True)  #Configure D1 input for 1007 sps. See documentation to adjust the samples per second.
...
while True:
    ...
    print("Ntot = " + str(Ntot))
    #Data stream is D0, D1, D0, etc.
    data1 = data[0::2]  # This will take every other element starting from the first element. This will give you the D0 data
    data2 = data[1::2] # This will take every other element starting from the second element. This will give you the D1 data

    data_set = [data1, data2] # Creates an array of the 2 datas, easily modifiable for 3 or more data streams
    ...
    for data in data_set:
        ...
        plot_count += 1 # Increment the plot count so that the next plot will be on a new figure       
